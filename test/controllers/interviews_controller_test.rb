...
class InterviewsControllerTest < ActionController::TestCase
  ...
  test "should create interview" do
    assert_difference('Interview.count') do
      post :create, interview: { description: @interview.description, name: @interview.name, title: @interview.title, user_id: @interview.user_id }
    end
  ...
  test "should update interview" do
    patch :update, id: @interview, interview: { description: @interview.description, name: @interview.name, title: @interview.title, user_id: @interview.user_id }
    assert_redirected_to interview_path(assigns(:interview))
  end
